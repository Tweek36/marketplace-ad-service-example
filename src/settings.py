...
class Settings(BaseSettings):
    ...
    def __init__(self, **kwargs):
        ...
        if self.postgres_connection_string:
            ...
            if self.postgres_username and self.postgres_password and self.postgres_host and self.postgres_port and self.postgres_database_name:
                ...
                raise ValueError("Either POSTGRES_CONNECTION_STRING or all PostgreSQL connection parameters must be provided")
        ...
        if self.kafka_brokers:
            ...
            raise ValueError("Either KAFKA_BROKERS or KAFKA_BOOTSTRAP_SERVERS must be provided")
        ...
        if self.kafka_topic_marketplace_ads:
            ...
            raise ValueError("Either KAFKA_TOPIC_MARKETPLACE_ADS or KAFKA_TOPIC_ADS must be provided")
